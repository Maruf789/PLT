...
%token INT DOUBLE STRING BOOL MAT
%token <string> ID
...
arg_declare_list :
  ...
  | arg_declare_list COMMA dtype ID  { List.concat [$1; [{ vname = "_"; vtype = $3; }];] } /* discard ID */
  | arg_declare_list COMMA dtype     { List.concat [$1; [{ vname = "_"; vtype = $3; }];] }


/* a function declaration in struct */
func_declare:
    rtype ID LPAREN arg_declare_list RPAREN SEMI { (* function without return *)
        { return = $1; fname = $2; args = $4; locals = []; body = []; } 
      }
  | ID LPAREN arg_declare_list RPAREN SEMI {
...
/*                                   { [] }  */
  | func_declare                   { [$1] }
  | func_declare_list func_declare { $1 @ [$2] } /* maybe :: and List.rev */


/* argument list in function definition */
arg_def_list:
...
func_def:
    DEF rtype ID LPAREN arg_def_list RPAREN DO var_dec_def_list stmt_list FED {
