...
string s =  string("") ;
bool b =  false ;
(  i  = ( int_of_string( string("1.0") ) ) ) ;
cout <<  i  << endl;
(  d  = ( double_of_string( string("1.0") ) ) ) ;
cout <<  d  << endl;
(  s  = ( string_of_int(1.000000) ) ) ;
cout <<  s  << endl;
(  s  = ( string_of_double(1.100000) ) ) ;
cout <<  s  << endl;
(  b  = ( ( int_of_string( string("2") ) ) > ( int_of_string( string("1") ) ) ) ) ;
cout <<  b  << endl;
(  b  = ( ( double_of_string( string("22.2") ) ) > ( double_of_string( string("100.3") ) ) ) ) ;
cout <<  b  << endl;
