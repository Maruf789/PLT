...
string T_2_0[] = {};
string_mat TT_2_0 = ( string_mat( T_2_0  ,  0  ,  0 ) );
string_mat sx =  TT_2_0 ;
(  ax  = ( mat_int_of_string( TT_6_0 ) ) ) ;
cout <<  ax  << endl;
(  dx  = ( mat_double_of_string( TT_8_0 ) ) ) ;
cout <<  dx  << endl;
(  sx  = ( mat_string_of_int( TT_10_0 ) ) ) ;
cout <<  sx  << endl;
(  sx  = ( mat_string_of_double( TT_12_0 ) ) ) ;
cout <<  sx  << endl;
(  dx  = ( mat_double_of_int( ax ) ) ) ;
cout <<  dx  << endl;
(  ax  = ( mat_int_of_double( TT_16_0 ) ) ) ;
cout <<  ax  << endl;
return  0  ;
}
