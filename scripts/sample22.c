...
int_mat ax =  TT_0_0 ;
double T_1_0[] = {1.100000 , 2.200000 , 3.300000 , 4.400000};
double_mat TT_1_0 = ( double_mat( T_1_0  ,  2  ,  2 ) );
double_mat dx =  TT_1_0 ;
string T_2_0[] = { string("ab")  ,  string("cd")  ,  string("ef")  ,  string("gh") };
string_mat TT_2_0 = ( string_mat( T_2_0  ,  2  ,  2 ) );
